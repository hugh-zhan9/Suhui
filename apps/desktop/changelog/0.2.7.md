...
![](https://github.com/hugh-zhan9/assets/blob/main/0.2.7/move-category.png?raw=true)

2. New `Expand long social media` setting to automatically expand social media entries containing long text.

![](https://github.com/hugh-zhan9/assets/blob/main/0.2.7/expand-long-social-media.png?raw=true)

3. New `Back Top` button and read progress indicator in entry content

![](https://github.com/hugh-zhan9/assets/blob/main/0.2.7/read-indicator.png?raw=true)
