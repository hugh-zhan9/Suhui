...
import { LazyKateX } from "@suhui/components/ui/katex/lazy.js"
import { hastToContent, parseHtml as parseHtmlGeneral } from "@suhui/utils/html"
...
export const parseHtml = (
  ...
  parseHtmlGeneral(content, {
    ...options,
    components: getHtmlComponents(),
  })
