...
import type { SourceContentStatus } from "./source-content-state"
import {
  ...
  return (
    <div className="relative flex size-full flex-col">
      {allowReturnToArticle && (
        <div
          className="no-drag-region shrink-0 border-b border-fill-secondary p-2"
          data-hide-in-print
        >
          <Button variant="ghost" onClick={closeOriginalView} buttonClassName="no-drag-region">
            <i className="i-mgc-arrow-left-cute-re mr-1.5" aria-hidden />
            {t("entry_actions.return_to_reader")}
          </Button>
        </div>
      )}
