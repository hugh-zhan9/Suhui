# 任务计划：Suhui 远程访问实现与文档同步

## 目标

保持远程访问相关文档与当前代码实现同步，避免 `AI-CONTEXT.md`、spec、plan 与实际实现状态脱节。
...
- [x] 识别已经落后于代码的主上下文和设计文档
- [x] 更新 `AI-CONTEXT.md` 中的产品现状、远程能力与边界
- [x] 更新远程访问 spec 的实现快照
- [x] 更新详细设计计划中的当前实现状态
- [x] 同步规划文件，记录这次文档维护
- **状态：** complete
...
1. 如何继续在不复制业务逻辑的前提下，把现有 IPC 主链路收敛成 HTTP + IPC 共用服务层。
2. 如何在“阅读优先”的产品取舍下，持续推进远程端能力且保持文档准确。
